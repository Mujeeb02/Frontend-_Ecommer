...
import LatestProductCard from "../components/FlipCard"
const Home = () => {
  ...
  return (
    <div className="home bg-[#F3F4F6] overflow-hidden">
      {/* Hero Section */}
      ...
      <ServiceCard />
      <h1 style={{ fontFamily: "ubuntu" }} className="text-xl md:text-4xl text-gray-500 font-[700] flex justify-between ml-[5vw] mr-[5vw]">Latest Products <Link to="/search" className="findmore flex justify-center items-center gap-4">more <FaArrowAltCircleRight /></Link> </h1>
      <main className="flex flex-wrap items-center justify-center overflow-x-auto md:min-h-[60vh]">
        {
          isLoading ? <Skeleton /> :
            data?.data.map((i) => (
              <LatestProductCard
